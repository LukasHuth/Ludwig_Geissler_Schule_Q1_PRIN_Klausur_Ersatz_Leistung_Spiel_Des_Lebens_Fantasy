...
public class Window implements GLEventListener, KeyListener {
    // TODO: Make it like the example c++ opengl code
    /*
    #include <stdio.h>
    #include <stdlib.h>
    ...
    public void setup()
    {
        ...
        window.setTitle(Utils.gamename);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        program = new Program(gl, "shaders/gl4", "triangle", "triangle");
    ...
    private void initBuffers(GL4 gl) {
        ...
        if(!bug1287) {
            gl.glNamedBufferStorage(bufferName.get(Buffer.VERTEX), vertexBuffer.capacity() * Float.BYTES, vertexBuffer, GL_STATIC_DRAW);
            gl.glNamedBufferStorage(bufferName.get(Buffer.ELEMENT), vertexBuffer.capacity() * Short.BYTES, elementBuffer, GL_STATIC_DRAW);
    ...
    private class Program {
        ...
        public Program(GL4 gl, String root, String vertex, String fragment) {
            ShaderCode vertShader = ShaderCode.create(gl, GL_VERTEX_SHADER, this.getClass(), root, null, vertex, "vert", null, true);
            ShaderCode fragShader = ShaderCode.create(gl, GL_FRAGMENT_SHADER, this.getClass(), root, null, fragment, "frag", null, true);
